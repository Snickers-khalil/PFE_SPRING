...
class NowUIColors {
  ...
  static const Color logo = Color.fromRGBO(218, 184, 92, 0.8);
  ...
  static const Color bluemarine = Color.fromRGBO(50, 50, 93, 1.0);
  ...
  static const Color trans = Color.fromRGBO(0, 0, 0, .4);
  static const Color trans2 = Color.fromRGBO(220, 220, 220, .7);
}
